...
# Extraemos el ewspaper_uid del bimbre del archivo
...
# Agremamos una columna el newspaper uid
...
# Llenar los campos vacios del titulo
...
# Generar uids en todos los registros
...
# Removiendo los saltos de linea
...
# Contando la cantidad de palabras que contiene
...
def _save_data(df, filename):
    clean_filename = '{}_clean'.format(filename)
